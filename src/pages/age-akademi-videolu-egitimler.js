        ...
        <div className="row">
          <div className="col-lg-5 col-12">
            <div className="coming-soon-content-wrap position-relative z-2">
              ...
              <h5 className="text-white">Yakında...</h5>
              <h1 className="text-white">
                Age Akademi için çalışmalarımız devam ediyor. En kısa sürede tüm
                eğitim videolarımızı burada bulabileceksiniz.
              </h1>
