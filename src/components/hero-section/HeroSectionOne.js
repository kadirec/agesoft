        ...
        <div className="row justify-content-center text-center text-lg-start align-items-center">
          <div className="col-lg-6 col-md-10">
            <div className="hero-content-wrap mt-5 mt-lg-0 mt-xl-0">
              ...
              <p className="lead">
                Agesoft ile E-ticaret Süreçlerinizi, Pazaryerleri
                entegrasyonlarını, ERP-Muhasebe Entegrasyonlarını, Faturalama
                Süreçlerinizi Tek Panel İle Yönetetirsiniz.
              </p>
              ...
              >
                <li className="nav-item">
                  <span className="ms-0">
                    <i className="far fa-check-circle text-primary me-2"></i>14
                ...
                <li className="nav-item">
                  <span className="ms-0">
                    <i className="far fa-check-circle text-primary me-2"></i>
                    Yenileme Maliyetini Düşürün
                  </span>
                </li>
                <li className="nav-item">
                  <span>
                    <i className="far fa-check-circle text-primary me-2"></i>
                    Bütçeden Tasarruf Edin
                  </span>
                </li>
              </ul>
              ...
              <div className="action-btn mt-5 align-items-center d-block d-sm-flex d-lg-flex d-md-flex">
                <Link href="/request-demo">
                  <a className="btn btn-primary me-lg-3 me-sm-3">
                    E-ticaret Paketleri
                  </a>
                </Link>

                <Link href="/request-demo">
                  <a className="btn btn-color-white">E-ticaret Paketleri</a>
                </Link>
              </div>
            </div>
          </div>
