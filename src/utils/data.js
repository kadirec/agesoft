...
const TestimonialOneData = [
  {
    ...
    activeClass: "active",
    authorThumb: "/logo/evviwa-beyaz.png",
    authorName: "Evviwa Mobilya",
    authorTitle: "Ad Soyad - Kurucu Ortak",
    quoteTitle: "Başlık",
    authorQuote: "Açıklama",
  },
  {
...
const navCompanyLinks = [
  {
    title: "Buy-Box Modülü",
    icon: <BiPaperPlane />,
    href: "integration-single",
  },
  {
    title: "Instashop Modülü",
    icon: <BiLogIn />,
    href: "contact-us",
  },
  {
    title: "Hızlı Satış Modülü",
    icon: <BiServer />,
    href: "single-service",
  },
  {
    title: "Gelişmiş Seo Modülü",
    icon: <BiNews />,
    href: "blogs",
  },
  {
    title: "Gelişmiş Tema Editörü",
    icon: <BiDetail />,
    href: "blog-single",
  },
  {
    title: "Ürün Kombin Modülü",
    icon: <HiOutlineAcademicCap />,
    href: "career",
  },
  {
    title: "Gelişmiş Reklamcılık Araçları",
    icon: <HiOutlineAcademicCap />,
    href: "career-single",
  },
  {
    title: "Riskli Sipariş Modülü",
    icon: <BiRocket />,
    href: "integrations",
  },
  {
    title: "Çek/Senet Ödeme Modülü",
    icon: <BiPaperPlane />,
    href: "integration-single",
  },
  {
    title: "Age Story Modülü",
    icon: <BiPaperPlane />,
    href: "integration-single",
  },
];
